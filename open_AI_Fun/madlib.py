...
class Application(Frame):
    ...
    def tell_story(self):
        ...
        story += noun
        story += " found the explorer. "
        story += "Surrounded by "
        story += adjectives
        story += " it sent "
        story += person + " "
        story += "running in fear. The quest was finally over. A tear came to "
        story += person + "'s "
        story += "eye. After all this time, the quest was finally over. And then, the "
        story += noun
